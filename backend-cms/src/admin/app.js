  ...
  config: {
    ...
    translations: {
      ...
      // -------
        ...
        "Auth.form.register.subtitle": "Credentials are only used to authenticate in Hyperce. All saved data will be stored in your database.",
        ...
        "HomePage.welcome.congrats.content": "You are logged in as the first administrator. To discover the powerful features provided by Hyperce,",
        ...
        "admin.pages.MarketPlacePage.offline.subtitle": "You need to be connected to the Internet to access Hyperce Market.",
        ...
        "admin.pages.MarketPlacePage.plugin.tooltip.madeByStrapi": "Made by Hyperce",
        "admin.pages.MarketPlacePage.plugin.tooltip.verified": "Plugin verified by Hyperce",
        "admin.pages.MarketPlacePage.plugin.version": "Update your Hyperce version: \"{strapiAppVersion}\" to: \"{versionRange}\"",
        "admin.pages.MarketPlacePage.plugin.version.null": "Unable to verify compatibility with your Hyperce version: \"{strapiAppVersion}\"",
        ...
        "admin.pages.MarketPlacePage.tab-group.label": "Plugins and Providers for Hyperce",
        ...
        "app.components.HomePage.welcomeBlock.content": "Congrats! You are logged as the first administrator. To discover the powerful features provided by Hyperce, we recommend you to create your first Content type!",
        "app.components.HomePage.welcomeBlock.content.again": "We hope you are making progress on your project! Feel free to read the latest news about Hyperce. We are giving our best to improve the product based on your feedback.",
        ...
        "app.components.MarketplaceBanner": "Discover plugins built by the community, and many more awesome things to kickstart your project, on Hyperce Marketplace.",
        ...
        "app.components.NpsSurvey.banner-title": "How likely are you to recommend Hyperce to a friend or colleague?",
        ...
        "components.AutoReloadBlocker.description": "Run Hyperce with one of the following commands:",
        ...
        "global.plugins.sentry.description": "Send Hyperce error events to Sentry.",
        ...
        "notification.ee.warning.over-.message": "Add seats to {licenseLimitStatus, select, OVER_LIMIT {invite} AT_LIMIT {re-enable}} Users. If you already did it but it's not reflected in Hyperce yet, make sure to restart your app.",
        ...
        "notification.version.update.message": "A new version of Hyperce is available!",
