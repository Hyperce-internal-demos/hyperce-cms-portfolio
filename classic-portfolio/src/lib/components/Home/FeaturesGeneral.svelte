      ...
      <div class="space-y-6 sm:space-y-8">
        ...
        <div class="space-y-2 md:space-y-4">
          <h2 class="font-bold text-3xl lg:text-4xl text-gray-800 dark:text-gray-200">
            {remainingString + " "}<a href="#" class="text-yellow-600"> {lastWord}</a>  
          </h2>
          <p class="text-gray-500">
            {data?.FeaturesGeneralDescription}
          </p>
        </div>
        <!-- End Title -->
        ...
        <ul role="list" class="space-y-2 sm:space-y-4">
          {#each data?.features_list as feature}
            <li class="flex space-x-3">
              <!-- Solid Check -->
              <svg class="flex-shrink-0 h-6 w-6 text-violet-600 dark:text-violet-500" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M10.9295 4.88618C11.1083 4.67577 11.4238 4.65019 11.6343 4.82904C11.8446 5.00788 11.8702 5.32343 11.6914 5.53383L7.44139 10.5338C7.25974 10.7475 6.93787 10.77 6.72825 10.5837L4.47825 8.5837C4.27186 8.40024 4.25327 8.08420 4.43673 7.87781C4.62019 7.67142 4.93622 7.65283 5.14261 7.83629L7.01053 9.49669L10.9295 4.88618Z" fill="currentColor"/>
              </svg>
              <!-- End Solid Check -->
