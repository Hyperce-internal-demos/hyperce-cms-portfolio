<!-- Icon Blocks -->
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto my-2" id="feature-card-section">
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-3 xl:gap-6">
      <!-- Card -->
      <a class="group transition ease-linear hover:scale-105 hover:-translate-y-2 flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all dark:hover:bg-white/[.075]" href="#">
        <svg class="flex-shrink-0 w-8 h-8 text-red-800 mt-0.5 mr-6 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
      ...
      <!-- Card -->
      <a class="group transition ease-linear hover:scale-105 hover:-translate-y-2 flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all dark:hover:bg-white/[.075]" href="#">
        <svg class="flex-shrink-0 w-8 h-8 text-violet-800 mt-0.5 mr-6 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
      ...
      <!-- Card -->
      <a class="group transition ease-linear hover:scale-105 hover:-translate-y-2 flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all dark:hover:bg-white/[.075]" href="#">
        <svg class="flex-shrink-0 w-8 h-8 text-green-800 mt-0.5 mr-6 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
