<!-- Card Blog -->
<div class="max-w-[85rem] px-4 py-10 my-10 sm:px-6 lg:px-8 lg:py-20 mx-auto">
  <!-- Title -->
  <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
    <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">Blogs</h2>
    <p class="mt-1 text-gray-600 dark:text-gray-400">Stay in the know with blogs from us.</p>
  </div>
  <!-- End Title -->
  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <a class="group rounded-xl overflow-hidden" href="#">
      ...
      <div class="mt-7">
        ...
        <p class="mt-3 text-gray-800 dark:text-gray-200">
          Produce professional, reliable streams easily leveraging Hyperce's innovative broadcast studio
        </p>
    ...
    <a class="group relative flex flex-col w-full min-h-[15rem] bg-center bg-cover rounded-xl hover:shadow-lg transition bg-[url('https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3000&q=80')]" href="#">
      <div class="flex-auto p-4 md:p-6">
        <h3 class="text-xl text-white/[.9] group-hover:text-white"><span class="font-bold">Hyperce</span> Press publishes books about economic and technological advancement.</h3>
      </div>
