...
<div class="py-20 md:py-24 relative" id="intro-section">
  <div class="-z-10 video-docker brightness-[0.30] absolute top-0 left-0 w-full h-full overflow-hidden">
    <video class="min-w-full min-h-full absolute object-cover" src="{video}" type="video/mp4" autoplay muted loop></video>
  </div>
  <!-- <div class="w-full h-full absolute -z-10 top-0 bg-image-darken bg-no-repeat brightness-[0.30] w-full h-full bg-cover bg-[url('https://content.gallup.com/origin/gallupinc/GallupSpaces/Production/Cms/WORKPLACEV9CMS/3-rifkq7g0kj79ubfl0zua.jpg')]">
  ...
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8">
    ...
    <div class="max-w-3xl text-center mx-auto">
      <h1 class="block font-bold text-white text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
        Designed for you to get more  <a class="text-violet-500" href="#">simple</a>
      </h1>
    </div>
    <!-- End Title -->

    <div class="max-w-3xl text-center mx-auto">
      <p class="text-xl text-gray-300">Build your business here. Take it anywhere.</p>
    </div>
