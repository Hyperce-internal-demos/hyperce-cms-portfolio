<div class="max-w-[50rem] h-[70vh] flex flex-col justify-center align-center mx-auto w-full">
    <div class="text-center py-10 px-4 sm:px-6 lg:px-8">
        ...
        <a class="mt-5 w-full sm:w-auto inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold text-blue-500 hover:text-blue-700 transition-all text-sm py-3 px-4 dark:ring-offset-slate-900" href="/">
